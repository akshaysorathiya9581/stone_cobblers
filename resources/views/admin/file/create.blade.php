...
.file-card { width:220px; border:1px solid #eee; padding:10px; border-radius:6px; background:#fff; }
.file-thumb img{ max-width:100%; height:auto; display:block; margin-bottom:8px; }
.empty { padding:20px; color:#666; }
.ajax-upload-progress{ height:6px; background:#e9ecef; border-radius:4px; overflow:hidden; margin-top:8px; }
.ajax-upload-progress > i{ display:block; height:100%; width:0%; background:#17a2b8; transition:width .2s ease; }
.upload-area.dragover { border-color:#17a2b8; background:#f8feff; }
</style>
@endpush
...
<div class="main-content">
    ...
    <div class="content">
        ...
        <div class="upload-section" style="margin-top:12px;">
            <div class="upload-area" id="uploadArea" style="border:2px dashed #e1e1e1; padding:18px; border-radius:8px; text-align:center; cursor:pointer;">
