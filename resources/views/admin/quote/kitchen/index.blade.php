...
@section('content')
    ...
    <div class="main-content">
        <!-- Header -->
        <x-header :export-url="null" :create-url="route('admin.kitchen.quotes.create')" export-label="Export Quote"
            create-label="New Kitchen Quote" />
        ...
        <div class="content">
            ...
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item">Kitchen Quotes</span>
            </div>

            <div class="content-header">
                <h1 class="content-title">Kitchen Quotes Management</h1>
                <div class="action-buttons">
                    <a href="#" class="btn secondary">
                        <i class="fas fa-chart-bar"></i> Reports
                    </a>
                    <a href="{{ route('admin.kitchen.quotes.create') }}" class="btn primary">
                        <i class="fas fa-plus"></i> Create Kitchen Quote
                    </a>
                </div>
            </div>
            ...
            <div class="tabs mb-15">
                ...
                <a href="{{ route('admin.kitchen.quotes.index') }}" class="tab {{ $current ? '' : 'active' }}">All Kitchen Quotes</a>
                <a href="{{ route('admin.kitchen.quotes.index', ['status' => 'Draft']) }}"
                    class="tab {{ $current === 'Draft' ? 'active' : '' }}">Draft</a>
                <a href="{{ route('admin.kitchen.quotes.index', ['status' => 'Sent']) }}"
                    class="tab {{ $current === 'Sent' ? 'active' : '' }}">Sent</a>
                <a href="{{ route('admin.kitchen.quotes.index', ['status' => 'Approved']) }}"
                    class="tab {{ $current === 'Approved' ? 'active' : '' }}">Approved</a>
                <a href="{{ route('admin.kitchen.quotes.index', ['status' => 'Rejected']) }}"
                    class="tab {{ $current === 'Rejected' ? 'active' : '' }}">Rejected</a>
                <a href="{{ route('admin.kitchen.quotes.index', ['status' => 'Expired']) }}"
