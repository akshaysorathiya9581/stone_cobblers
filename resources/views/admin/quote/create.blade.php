    ...
    <div class="content bg-content">
      <div class="welcome-container card" id="welcome-panel">
        <div class="quote-type">
          ...
          <p class="description">Transform your outdoor space with our premium stone cobbling services. Let's gather some
            details to provide you with a personalized quote.</p>
      ...
      <form id="multi-step-form" class="hidden quote-details" method="POST" action="{{ route('admin.quotes.store') }}">
        ...
        <div class="container step" data-step="1" id="step-1">
            ...
            <tbody id="kitchen-rows">
              ...
              @foreach($kitchenLabels as $label)
                <tr data-name="{{ $label }}">
                  ...
                  <td class="taxed-t">
                    {{ in_array($label, ['Kitchen - Sq Ft', 'Undermount Sink', 'small oval sink']) ? 'T' : '' }}
                  </td>
                </tr>
              @endforeach
            </tbody>
          ...
          <div class="nav-footer">
            <button type="button" id="prev-tab-1" class="btn secondary" onclick="prevStep(1)" disabled><span>←</span>
              Previous</button>
        ...
        <div class="container step hidden" data-step="2" id="step-2">
          ...
          <div class="table-container">
            ...
            <div style="margin-bottom: 30px;">
              <h3 style="background-color: #fff3cd; padding:10px; margin:0; border-bottom:1px solid #e0e0e0;">CABINET
                MANUFACTURER</h3>
                  ...
                  @foreach(['bertch', 'mantra', 'CB', '802/USCD FROM 2020', 'KCD/USCD', 'dura', 'OMEGA'] as $i => $mfg)
                    <tr data-name="{{ $mfg }}">
                      ...
                      <td style="padding:8px;border:1px solid #e0e0e0;text-align:center;">
                        <input type="number" name="manufacturer[qty][]" class="qty-input manufacturer-qty" min="0"
                          step="0.01" value="{{ old('manufacturer.qty.' . $i, 0) }}" style="width:100%;">
                      </td>
              ...
              <table class="table" style="margin-bottom:20px;width:100%;">
                <tr>
                  ...
                  <td style="width:20%;padding:8px;border:1px solid #e0e0e0;background-color:#e8f5e8;">
                    <input type="number" id="list-price" name="list_price" class="qty-input" placeholder="num fill"
                      min="0" step="0.01" value="0">
                  </td>
                  <td id="multiplier-result" style="width:25%;padding:8px;border:1px solid #e0e0e0;text-align:right;">
                    0.000</td>
            ...
            <!-- Margin Markup -->
            <div style="margin-bottom: 30px;">
              <h3 style="background-color:#f5f5f5;padding:10px;margin:0;border-bottom:1px solid #e0e0e0;">MARGIN MARKUP
              </h3>
              <table class="table" style="margin-bottom:20px;width:100%;">
                <tr>
                  ...
                  <td style="width:20%;padding:8px;border:1px solid #e0e0e0;">
                    <input type="number" name="margin_markup" id="margin-markup" class="qty-input" placeholder="1.60"
                      min="0" step="0.01" value="1.60">
                  </td>
                  <td id="markup-result" style="width:50%;padding:8px;border:1px solid #e0e0e0;text-align:right;">0.00
                  </td>
                </tr>
              </table>
            </div>
              ...
              <table class="table" style="margin-bottom:20px;width:100%;">
                ...
                <tr>
                  ...
                  <td style="padding:8px;border:1px solid #e0e0e0;background:#ffb74d;">
                    <input type="number" id="hardware-qty" name="hardware_qty" class="qty-input" placeholder="0.00"
                ...
                <tr>
                  ...
                  <td style="padding:8px;border:1px solid #e0e0e0;background:#ffcdd2;">
                    <input type="number" id="price-buffer" name="price_buffer" class="qty-input" placeholder="0.00"
                      min="0" step="0.01" value="0.00">
                  </td>
                ...
                <tr>
                  ...
                  <td style="padding:8px;border:1px solid #e0e0e0;background:#ffcdd2;">
                    <input type="number" id="phone-call-buffer" name="phone_call_buffer" class="qty-input"
                ...
                <tr>
                  ...
                  <td id="total-retail" style="padding:8px;border:1px solid #e0e0e0;text-align:right;background:#e8f5e8;">
                    0.00</td>
                </tr>
            ...
            <div style="margin-bottom: 30px;">
              ...
              <table class="table" style="margin-bottom:20px;width:100%;">
                <tr>
                  ...
                  <td style="width:20%;padding:8px;border:1px solid #e0e0e0;text-align:right;">
                ...
                <tr>
                  ...
                  <td style="padding:8px;border:1px solid #e0e0e0;text-align:right;">
                    {{ fmtAuto($manufacturers['UP TO TEN ITEMS'] ?? '175.00') }}
                  </td>
                  <td style="padding:8px;border:1px solid #e0e0e0;background:#f5f5f5;">
                    <input type="number" id="delivery-ten-items" name="delivery_ten_items" class="qty-input"
                      placeholder="" min="0" step="0.01" value="0">
                  </td>
                  <td id="delivery-ten-items-total" style="padding:8px;border:1px solid #e0e0e0;text-align:right;">0.00
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="padding:8px;border:1px solid #e0e0e0;text-align:right;">
                    {{ fmtAuto($manufacturers['SINGLE ITEM VAN'] ?? '100.00') }}
                  </td>
                  <td style="padding:8px;border:1px solid #e0e0e0;background:#f5f5f5;">
                    <input type="number" id="delivery-single-van" name="delivery_single_van" class="qty-input"
                      placeholder="" min="0" step="0.01" value="0">
                  </td>
                  <td id="delivery-single-van-total" style="padding:8px;border:1px solid #e0e0e0;text-align:right;">0.00
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="padding:8px;border:1px solid #e0e0e0;background:#f5f5f5;">
                    <input type="number" id="delivery-pickup" name="delivery_pickup" class="qty-input" placeholder=""
                      min="0" step="0.01" value="0">
                  </td>
                ...
                <tr>
                  <td colspan="3"
                    style="padding:8px;border:1px solid #e0e0e0;text-align:right;font-weight:bold;background:#e8f5e8;">
                    TOTAL</td>
                  <td id="delivery-total"
                    style="padding:8px;border:1px solid #e0e0e0;text-align:right;background:#e8f5e8;">0.00</td>
                </tr>
              </table>
            </div>
            ...
            <div>
              <table class="table" style="width:100%;margin-bottom:20px;">
                <tr>
                  ...
                  <td style="width:20%;padding:8px;border:1px solid #e0e0e0;">
                    <input type="number" id="dba-surcharge" name="dba_surcharge" class="qty-input" placeholder="0.03"
                      min="0" step="0.01" value="0.03">
                  </td>
                  <td id="step2-final-result" style="width:50%;padding:8px;border:1px solid #e0e0e0;text-align:right;">
                    0.00</td>
                </tr>
                <tr>
                  <td style="padding:8px;border:1px solid #e0e0e0;font-weight:bold;">step 2 subtotal</td>
                  <td style="padding:8px;border:1px solid #e0e0e0;"></td>
                  <td id="step2-final-total"
                    style="padding:8px;border:1px solid #e0e0e0;text-align:right;font-weight:bold;">0.00</td>
                </tr>
              </table>
            </div>
          </div>
