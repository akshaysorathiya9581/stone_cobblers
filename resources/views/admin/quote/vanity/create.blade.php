...
@section('title', 'Vanity Quotes — Prices')
        ...
        <div class="content bg-white">
            <div class="quote-details">
                ...
                <div class="content-header d-block">
                    <h2 class="title">Stone by Stone: Your Perfect Vanity Quote</h2>
                ...
                <div class="quote-stepview project-step">
                    <div class="quote-stepview__full" style="max-width: 600px;">
                        <div class="stepview-title text-align-left">
                            ...
                            <p>Choose the project for which you want to create a vanity quote</p>
                        </div>
                        <div class="form-fields">
                            <!-- Hidden field for quote type -->
                            <input type="hidden" id="quote_type" name="quote_type" value="vanity">
                ...
                <div class="quote-stepview success-step" style="display: none;">
                    <div class="quote-stepview__full">
                        ...
                        <div class="success-step__flex">
                            <a href="{{ route('admin.vanity.quotes.index') }}" class="btn theme">View All Quotes</a>
                            <a href="{{ route('admin.vanity.quotes.create') }}" class="btn secondary">Create Another Quote</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        jQuery(function ($) {
            ...
            function submitQuoteForm() {
                ...
                const formData = {
                    ...
                    quote_type: $('#quote_type').val() || 'vanity', // Include quote type
